...
#0 = XO, 1 = SPO OIC, 2 = MAJ1, 3 = MAJ2  (2 and 3 are majors from brigade)
...
def reset_r(r, thresh):
    r = [
        ("MAJ A", "XO", thresh, 18),
        ("MAJ B", "SPO", thresh, 18),
        ("MAJ C", "unassigned", thresh, 0),
        ("MAJ D", "unassigned", thresh, 0),
        ("MAJ E", "unassigned", thresh, 0)
        ]
    return (r)

def assign_O4s_one_run(threshold):
    roster = []
    mob_positions = []
